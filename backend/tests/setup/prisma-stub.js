...
module.exports = {
  ...
  default: {
    ...
    release: modelStub(),
    mcpApiKey: modelStub(),
    mcpOAuthClient: modelStub(),
    mcpOAuthCode: modelStub(),
    mcpOAuthGrant: modelStub(),
    nameBlacklist: modelStub(),
    nameBlacklistEntry: modelStub(),
    session: modelStub(),
    adminUser: modelStub(),
    message: modelStub(),
    discordMessageLink: modelStub(),
    discordRelayMapping: modelStub(),
    autoModRule: modelStub(),
    autoModViolation: modelStub(),
    banEvidence: modelStub(),
    userAlias: modelStub(),
    embedAsset: modelStub(),
