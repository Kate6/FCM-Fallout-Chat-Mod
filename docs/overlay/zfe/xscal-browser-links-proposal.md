...
[supplied ZFE browser-v1 contract](zfe-browser-links-v1-author-spec.md), with xScal-specific discovery
...
bundle is [the disclosed origin list](browser-links.md#configure-site-allowances); names are
