...
Superseded by [0.2.0 local export](README.md). Old linking/network/install steps below
...
[architecture, protocol and acceptance guide](../../../docs/overlay/zfe/background-server-bridge.md).
...
The complete suite now includes the [isolated packaged bridge](../../../docs/testing/hud-automation-plan.md#isolated-packaged-bridge-gate),
...
see the [evidence record](../../../docs/testing/hud-xscal-acceptance-2026-09-15.md#016-native-result--payload-boundary-still-failing).
The previous
...
[complete change-to-install gate](../../../docs/testing/hud-automation-plan.md#required-change-to-install-flow),
...
exception remains unknown. See the [dated evidence](../../../docs/testing/hud-xscal-acceptance-2026-09-15.md#013-native-exceptions-and-014-diagnostic-candidate).
