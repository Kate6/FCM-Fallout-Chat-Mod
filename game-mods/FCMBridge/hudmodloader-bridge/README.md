...
## Shared collector candidate (0.1.6)
...
python3 package.py --target dev --output ../../../_dev-test-builds/server-bridge-0.1.6/FCM-Server-Bridge-0.1.6-DEV.zip
```
